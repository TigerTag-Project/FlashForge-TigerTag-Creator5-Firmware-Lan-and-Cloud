...
(function () {
  ...
  var S = {
    en: {
      ...
      'btn.download': 'Download for {model}', 'btn.other': 'Looking for the {other}? →',
    ...
    fr: {
      ...
      'btn.download': 'Télécharger pour la {model}', 'btn.other': 'Vous cherchez la {other} ? →',
    ...
    de: {
      ...
      'btn.download': 'Download für {model}', 'btn.other': 'Suchst du den {other}? →',
    ...
    es: {
      ...
      'btn.download': 'Descargar para {model}', 'btn.other': '¿Buscas la {other}? →',
    ...
    it: {
      ...
      'btn.download': 'Scarica per {model}', 'btn.other': 'Cerchi la {other}? →',
    ...
    zh: {
      ...
      'btn.download': '下载 {model} 固件', 'btn.other': '找的是 {other}？→',
    ...
    pt: {
      ...
      'btn.download': 'Baixar para {model}', 'btn.other': 'Procurando a {other}? →',
    ...
    'pt-pt': {
      ...
      'chip.version': 'Versão', 'chip.official': '✓ Build oficial FlashForge',
      'btn.download': 'Descarregar para {model}', 'btn.other': 'Procura a {other}? →',
    ...
    pl: {
      ...
      'btn.download': 'Pobierz dla {model}', 'btn.other': 'Szukasz {other}? →',
    ...
    ru: {
      ...
      'btn.download': 'Скачать для {model}', 'btn.other': 'Нужна {other}? →',
    ...
    nl: {
      ...
      'btn.download': 'Downloaden voor {model}', 'btn.other': 'Zoek je de {other}? →',
